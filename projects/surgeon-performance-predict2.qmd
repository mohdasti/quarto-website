...
<div class="tldr-card" role="note" aria-label="TL;DR">
  ...
  <div class="tldr-text">
    Cut <b>high-load min/hr</b>, prevent <b>lapses</b>, and keep trainees in the <b>optimal zone</b> with <b>pupil + grip/tremor + HRV</b>—no headgear.<br><br>
    <b>For training:</b> a sandbox that teaches <em>why thresholds adapt</em> → a dashboard that <em>coaches in real time</em> → metrics that <em>prove learning happened</em>.
  </div>
...
<p><strong>Why this dashboard:</strong> combine deployable UX from SST with mechanistic LC–NE insight to deliver a
  <b>training-first, no extra wearables</b> cognitive monitor for robotic trainees.</p>
```
...
<div class="what-is-card">
  <div class="what-is-header">What this is / What this isn't</div>
  <div class="what-is-item">
    <span class="what-is-label what-is-positive">✓ What this is.</span>
    <span class="what-is-text">A deployable, no body-worn hardware <strong>training aid</strong> that fuses biosignals with robot telemetry to surface <strong>when</strong> coaching helps most.</span>
  </div>
  <div class="what-is-item">
    <span class="what-is-label what-is-negative">✗ What this isn't.</span>
    <span class="what-is-text">A medical device or punitive scoring system; it doesn't replace instructor judgment or certify clinical readiness.</span>
  </div>
</div>
```
