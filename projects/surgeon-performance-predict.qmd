...
tags: ["Human Factors", "Biomedical Engineering", "Cognitive Neuroscience", "Psychophysiology", "Machine Learning", "Pupillometry", "Experimental Design"]
...
> understanding the surgeon's cognitive state—the *why* behind their
> actions."

This project is my answer to that challenge. I developed a
proof-of-concept for a **"Cognitive Black Box"**—an end-to-end analytics platform that
...
The simulation creates 32,400 observations (3 surgeons × 10,800 seconds)
...
3-fold cross-validation—an industry-standard, high-performance model—to
