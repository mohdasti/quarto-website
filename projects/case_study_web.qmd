...
```{r results-dashboard-interactive, eval=has_highcharter && exists("df_raw_interactive") && !is.null(df_raw_interactive)}
...
```{r error-type-fig-interactive, eval=has_highcharter && exists("df_err_type_int") && !is.null(df_err_type_int)}
#| fig-cap: "Error Type Composition by Modality (interactive stacked bar - hover for percentages)"
if (has_highcharter && exists("df_err_type_int") && !is.null(df_err_type_int) && nrow(df_err_type_int) > 0) {
