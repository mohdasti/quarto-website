...
# The HTML is rendered to _site/projects/case_study_web.html, so images should be in _site/projects/images/
output_dir <- knitr::opts_knit$get("output.dir")
if (is.null(output_dir)) {
  # Fallback: assume we're rendering to _site/projects/
  output_dir <- file.path(getwd(), "_site", "projects")
}
...
src_file <- NULL
possible_sources <- c(
  file.path(getwd(), "docs", "assets", "case_study", "portfolio", "architecture.png"),
  file.path(getwd(), "docs", "case_study", "images", "architecture.png"),
...
src_file <- NULL
possible_sources <- c(
  file.path(getwd(), "docs", "case_study", "images", "participant_journey_final.png"),
  file.path(getwd(), "docs", "assets", "case_study", "participant_journey_final.png"),
  file.path(getwd(), "docs", "assets", "case_study", "portfolio", "participant_journey_final.png")
)
for (src in possible_sources) {
  if (file.exists(src)) {
    src_file <- src
...
src_file <- NULL
possible_sources <- c(
  file.path(getwd(), "docs", "case_study", "images", "Task_layout.png"),
  file.path(getwd(), "docs", "assets", "case_study", "Task_layout.png"),
  file.path(getwd(), "docs", "assets", "case_study", "portfolio", "Task_layout.png")
)
for (src in possible_sources) {
  if (file.exists(src)) {
    src_file <- src
...
if (has_interactive_data) {
  ...
  static_img <- file.path(getwd(), "docs", "assets", "case_study", "portfolio", "results_dashboard.png")
...
possible_csv_sources <- c(
  file.path(getwd(), "docs", "assets", "case_study", "results_at_a_glance.csv"),
  file.path(getwd(), "docs", "case_study", "results_at_a_glance.csv"),
...
if (has_err_type_data) {
  ...
  # Fallback to static image - always show this if interactive data is not available
  static_img <- file.path(getwd(), "docs", "assets", "case_study", "error_type_composition.png")
  if (file.exists(static_img)) {
    output_dir <- knitr::opts_knit$get("output.dir")
    if (is.null(output_dir)) {
      output_dir <- file.path(getwd(), "_site", "projects")
...
```{r endpoint-heatmap-static, eval=has_highcharter && exists("df_endpoint_int") && !is.null(df_endpoint_int)}
...
```{r endpoint-heatmap-adaptive, eval=has_highcharter && exists("df_endpoint_int") && !is.null(df_endpoint_int)}
...
if (has_highcharter && !is.null(df_endpoint_int) && !is.null(endpoint_axis_info)) {
  ...
  if (nrow(df_endpoint_both) > 0) {
    ...
    if (nrow(df_density_adaptive) > 0) {
      ...
      static_img <- file.path(getwd(), "docs", "assets", "case_study", "portfolio", "heatmap_endpoint_density.png")
      if (file.exists(static_img)) {
        output_dir <- knitr::opts_knit$get("output.dir")
        if (is.null(output_dir)) {
          output_dir <- file.path(getwd(), "_site", "projects")
...
```{r spatial-heatmap-hand, eval=has_highcharter && exists("df_spatial_int") && !is.null(df_spatial_int)}
...
if (has_highcharter && !is.null(df_spatial_int) && nrow(df_spatial_int) > 0) {
  ...
  if (nrow(df_hand_spatial) > 0) {
    ...
    # Fallback to static image
    static_img <- file.path(getwd(), "docs", "assets", "case_study", "portfolio", "heatmap_spatial_errors.png")
    if (file.exists(static_img)) {
      output_dir <- knitr::opts_knit$get("output.dir")
      if (is.null(output_dir)) {
        output_dir <- file.path(getwd(), "_site", "projects")
...
```{r spatial-heatmap-gaze, eval=has_highcharter && exists("df_spatial_int") && !is.null(df_spatial_int)}
...
src_file <- NULL
possible_sources <- c(
  file.path(getwd(), "docs", "assets", "case_study", "portfolio", "psychophysics.png"),
  file.path(getwd(), "docs", "case_study", "images", "psychophysics.png"),
  file.path(getwd(), "docs", "case_study", "portfolio", "psychophysics.png")
)
for (src in possible_sources) {
  if (file.exists(src)) {
    src_file <- src
