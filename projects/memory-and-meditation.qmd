...
description: "A mixed-methods study from recruitment through analysis, comparing napping and meditation for declarative and procedural memory consolidation."
outcome: "EEG · Mixed methods · Memory consolidation study"
categories: ["Cognitive Neuroscience", "EEG", "Mixed Methods"]
tags: ["Cognitive Neuroscience", "Applied Psychology", "Mixed Methods", "EEG", "Experimental Design"]
...
<div class="project-snapshot-card">
  <div class="ps-item"><span class="ps-label">Role</span><span class="ps-value">Master's Thesis — Full Study Design & Analysis</span></div>
  <div class="ps-item"><span class="ps-label">Methods</span><span class="ps-value">EEG, Mixed Methods, Memory Consolidation Paradigms, ANOVA, Repeated Measures</span></div>
  <div class="ps-item"><span class="ps-label">Stack</span><span class="ps-value">EEGLab, R, SPSS</span></div>
  <div class="ps-item"><span class="ps-label">Output</span><span class="ps-value">Master's thesis · Case study</span></div>
</div>
<div class="nserc-funding">
  <img
    class="nserc-funding__logo"
    src="../images/nserc-logo.svg"
    width="260"
    height="112"
    alt="Natural Sciences and Engineering Research Council of Canada"
  />
  <div class="nserc-funding__body">
    <p class="nserc-funding__lead">This Master's thesis research received support from the Natural Sciences and Engineering Research Council of Canada (NSERC).</p>
  </div>
</div>
```
...
* **My Action:** I designed and ran a mixed-methods study with 60+ participants: behavioral tasks (word-pair recall, a physical maze game), EEG, and self-report questionnaires.
