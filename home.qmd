...
<section class="hero-section">
  <div class="hero-inner">
    ...
    <div class="hero-content">
      ...
      <p class="hero-bio">
        I use psychophysics, pupillometry, and Bayesian modeling to study how
        people make decisions under pressure, and how that work can feed into
        interfaces and adaptive systems. Targeting Human Factors, Quant UXR, and
        Research Scientist roles in AR/VR/XR.
      </p>
      <div class="hero-ctas">
    ...
    <div class="featured-grid">
      ...
      <article class="project-card featured-card teal-accent">
        ...
        <p class="card-desc">
          ...
          Three instructional threshold policies for training. No headgear, &lt;60s setup.
        </p>
        <div class="card-tags">
...
<section class="contact-section">
  <div class="contact-inner">
    ...
    <p class="contact-sub">
      ...
      Research Scientist positions, with emphasis on AR/VR/XR and human performance.
    </p>
